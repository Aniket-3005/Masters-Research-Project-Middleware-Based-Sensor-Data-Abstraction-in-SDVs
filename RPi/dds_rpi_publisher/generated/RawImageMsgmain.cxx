        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<RawImageMsgApplication> app;
    ...
    else
    {
        try
        {
            app = RawImageMsgApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&RawImageMsgApplication::run, app);
